...
return {
  ...
  dependencies = {
    'nvim-lua/plenary.nvim',
    {
      ...
      build = 'make', -- `build` is used to run some command when the plugin is installed/updated (not every time nvim starts up
      cond = function()
        return vim.fn.executable 'make' == 1
      end, -- `cond` is a condition used to determine whether this plugin should be installed and loaded.
    },
